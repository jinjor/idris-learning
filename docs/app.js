...
var _idris_Main_46_main = function(oldbase){
  ...
  i$valstack[i$valstack_base + 1] = "Hey\n";
  i$valstack[i$valstack_top] = i$valstack[i$valstack_base];
  i$valstack[i$valstack_top + 1] = i$valstack[i$valstack_base + 1];
  i$SLIDE(2);
  i$valstack_top = i$valstack_base + 2;
...
var _idris_Prelude_46_Interactive_46_putStr_39_ = function(oldbase){
  ...
  i$valstack[i$valstack_base + 5] = new i$CON(65651,[i$valstack[i$valstack_base + 5],i$valstack[i$valstack_base + 1]],_idris__123_APPLY_95_0_125_$65651,null);
  i$valstack[i$valstack_base + 6] = i$CON$65648;
  i$ret = new i$CON(65649,[i$valstack[i$valstack_base + 2],i$valstack[i$valstack_base + 3],i$valstack[i$valstack_base + 4],i$valstack[i$valstack_base + 5],i$valstack[i$valstack_base + 6]],_idris__123_APPLY_95_0_125_$65649,null);
  i$valstack_top = i$valstack_base;
  i$valstack_base = oldbase.addr;
}
var _idris__123_APPLY_95_0_125_$65648 = function(oldbase,myoldbase){
...
var _idris__123_APPLY_95_0_125_$65649 = function(oldbase,myoldbase){
...
var _idris__123_APPLY_95_0_125_$65650 = function(oldbase,myoldbase){
...
var _idris__123_APPLY_95_0_125_$65651 = function(oldbase,myoldbase){
...
var _idris__123_APPLY_95_0_125_$65652 = function(oldbase,myoldbase){
...
var _idris_Prelude_46_Interactive_46__123_putStr_39__95_0_125_ = function(oldbase){
  ...
  i$ret = new i$CON(65650,[i$valstack[i$valstack_base + 1],i$valstack[i$valstack_base + 2],i$valstack[i$valstack_base + 3]],_idris__123_APPLY_95_0_125_$65650,null);
  i$valstack_top = i$valstack_base;
  i$valstack_base = oldbase.addr;
}
...
var _idris__123_io_95_bind_95_2_125_ = function(oldbase){
  var myoldbase = new i$POINTER();
  i$valstack_top += 1;
  i$ret = new i$CON(65652,[i$valstack[i$valstack_base],i$valstack[i$valstack_base + 1],i$valstack[i$valstack_base + 2],i$valstack[i$valstack_base + 3],i$valstack[i$valstack_base + 4],i$valstack[i$valstack_base + 5]],_idris__123_APPLY_95_0_125_$65652,null);
  i$valstack_top = i$valstack_base;
  i$valstack_base = oldbase.addr;
}
var i$CON$0 = new i$CON(0,[],null,null);
var i$CON$65648 = new i$CON(65648,[],_idris__123_APPLY_95_0_125_$65648,null);
var main = function(){
